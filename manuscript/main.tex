...
\section{Conclusion}
Based on WoSCC, this study utilises bibliometric and network analysis methods to review DL and multi-source data fusion in LULC classification from 2006 to 2025. Analysis of 261 publications reveals that since 2016, publication activity has increased within this predefined intersection. Because the search required both deep learning and fusion terms, it cannot establish that DL replaced traditional machine learning or that fusion became dominant across LULC research. China and Germany rank among the top three countries by publication count, TLCS, and TGCS within the retrieved corpus; these metrics do not measure national innovation capacity.
