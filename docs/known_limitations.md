...
3. Cropped screenshots recover several visible controls for the represented
   ...
   corresponding period input is pending; for 2021–2025, the input and thesaurus
   are identified but the threshold dialogue has not been supplied. The original
   counting method, hidden advanced parameters, a manuscript-compatible
   full-period settings capture, co-citation GUI settings, and saved network files
   are not available.
